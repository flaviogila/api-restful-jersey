...
public class MarcaDAO {
    ...
    public List<Marca> getAll() {
        ...
        try {
            ...
            throw new DAOException("Erro ao recuperar todas as marcas do banco: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
    ...
    public Marca getById(long id) {
        ...
        try {
            ...
            throw new DAOException("Erro ao buscar marca por id no banco de dados: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
    ...
    public Marca save(Marca marca) {
        ...
        try {
            ...
            throw new DAOException("Erro ao salvar marca no banco de dados: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
        return marca;
    ...
    public Marca delete(Long id) {
        ...
        try {
            ...
            em.getTransaction().rollback();
            throw new DAOException("Marca informada para remoção não existe: " + ex.getMessage(), ErrorCode.NOT_FOUND.getCode());
        } catch (RuntimeException ex) {
            em.getTransaction().rollback();
            throw new DAOException("Erro ao remover marca do banco de dados: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
    ...
    public List<Marca> getByPagination(int firstResult, int maxResults) {
        ...
        try {
            ...
            throw new DAOException("Erro ao buscar marcas no banco de dados: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }

        if (marcas.isEmpty()) {
            throw new DAOException("Página com marcas vazia.", ErrorCode.NOT_FOUND.getCode());
        }
    ...
    public List<Marca> getByName(String name) {
        ...
        try {
            ...
            throw new DAOException("Erro ao buscar marcas por nome no banco de dados: " + ex.getMessage(), ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
